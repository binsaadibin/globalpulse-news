...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var User, users, _i, users_1, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // Replace with your MongoDB Atlas connection string
                return [4 /*yield*/, mongoose.connect('mongodb+srv://golbalnews:zulfiqar4455@globalnews.yhhmhpy.mongodb.net/')];
                case 1:
                    // Replace with your MongoDB Atlas connection string
                    _a.sent();
                ...
                case 4:
                    _a.sent();
                    console.log("Created: ".concat(user.username));
                    _a.label = 5;
                case 5:
                    _i++;
                    return [3 /*break*/, 3];
