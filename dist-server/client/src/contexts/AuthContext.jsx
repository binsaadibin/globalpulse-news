...
export function AuthProvider(_a) {
    ...
    var _c = useState(null), currentUser = _c[0], setCurrentUser = _c[1];
    ...
    var validateToken = function (token) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fetch("".concat(API_BASE_URL, "/api/auth/me"), {
                            headers: {
                                'Authorization': "Bearer ".concat(token),
                            },
                        })];
    ...
    var checkAuthStatus = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 6:
                    error_2 = _a.sent();
                    console.error('Auth check failed:', error_2);
                    TokenManager.removeToken();
                    setIsAuthenticated(false);
                    setCurrentUser(null);
                    return [3 /*break*/, 8];
    ...
    var login = function (username, password) { return __awaiter(_this, void 0, void 0, function () {
        var response, data, expiryTime, errorMessage, error_3, errorMessage;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!username.trim() || !password.trim()) {
                        return [2 /*return*/, { success: false, message: 'Please enter both username and password' }];
                    }
                    if (password.length < 6) {
                        return [2 /*return*/, { success: false, message: 'Password must be at least 6 characters long' }];
                    }
                    return [4 /*yield*/, fetch("".concat(API_BASE_URL, "/api/auth/login"), {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    useEffect(function () {
        var checkTokenExpiry = setInterval(function () {
            if (isAuthenticated && TokenManager.isTokenExpired()) {
                logout();
            }
        }, 60000); // Check every minute
        return function () { return clearInterval(checkTokenExpiry); };
    }, [isAuthenticated]);
