...
export default function Admin() {
    ...
    var _a = useState(mockStats), stats = _a[0], setStats = _a[1];
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">
                      {t.welcomeAdmin}, <strong>{currentUser === null || currentUser === void 0 ? void 0 : currentUser.username}</strong>
                    </p>
                  </div>
                </div>
              </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {recentActivities.map(function (activity) { return (<div key={activity.id} className={"flex items-center gap-3 p-3 rounded-lg border ".concat(getActivityColor(activity.type))}>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 gap-3">
                      <Link href="/admin#users">
                        <Button variant="outline" className="w-full h-16 justify-start border-blue-200 hover:border-blue-300 hover:bg-blue-50 dark:border-blue-800 dark:hover:bg-blue-900/20">
                      ...
                      <Link href="/admin#analytics">
                        <Button variant="outline" className="w-full h-16 justify-start border-green-200 hover:border-green-300 hover:bg-green-50 dark:border-green-800 dark:hover:bg-green-900/20">
                          <div className="flex items-center gap-3 text-left">
                      ...
                      <Link href="/admin#settings">
                        <Button variant="outline" className="w-full h-16 justify-start border-purple-200 hover:border-purple-300 hover:bg-purple-50 dark:border-purple-800 dark:hover:bg-purple-900/20">
                          <div className="flex items-center gap-3 text-left">
